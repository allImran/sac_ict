...
<head>
    ...
    <link href="{{ asset('back') }}/assets/vendors/jquery-minicolors/jquery.minicolors.css" rel="stylesheet" />
    <!-- PAGE LEVEL STYLES-->
</head>
        ...
        <header class="header">
            <div class="page-brand">
                <a class="link" href="index.html">
                    <span class="brand">Sacrifice
                        <span class="brand-tip">ICT</span>
                    </span>
                ...
                <ul class="nav navbar-toolbar">
                            ...
                            <li class="list-group list-group-divider scroller" data-height="240px" data-color="#71808f">
                                <div>
                                    <a class="list-group-item">
                                        <div class="media">
                                            <div class="media-img">
                                                <img src="{{ asset('back') }}/assets/img/users/u1.jpg" />
                                            </div>
                                    ...
                                    <a class="list-group-item">
                                        <div class="media">
                                            <div class="media-img">
                                                <img src="{{ asset('back') }}/assets/img/users/u2.jpg" />
                                            </div>
                                            <div class="media-body">
                                    ...
                                    <a class="list-group-item">
                                        <div class="media">
                                            <div class="media-img">
                                                <img src="{{ asset('back') }}/assets/img/users/u3.jpg" />
                                            </div>
                                            <div class="media-body">
                                    ...
                                    <a class="list-group-item">
                                        <div class="media">
                                            <div class="media-img">
                                                <img src="{{ asset('back') }}/assets/img/users/u4.jpg" />
                                            </div>
                                            <div class="media-body">
                    ...
                    <li class="dropdown dropdown-user">
                        <a class="nav-link dropdown-toggle link" data-toggle="dropdown">
                            <img src="{{ asset('back') }}/assets/img/admin-avatar.png" />
                            <span></span>{{ Auth::user()->name }}<i class="fa fa-angle-down m-l-5"></i></a>
                        <ul class="dropdown-menu dropdown-menu-right">
                            <a onclick="event.preventDefault()" class="dropdown-item" href="profile.html"><i class="fa fa-user"></i>Profile</a>
                            <a onclick="event.preventDefault()" class="dropdown-item" href="profile.html"><i class="fa fa-cog"></i>Settings</a>
                            <a onclick="event.preventDefault()" class="dropdown-item" href="javascript:;"><i class="fa fa-support"></i>Support</a>
