...
<!--==========================================---------------=====================-->
            <li class=" @if(isset($activesateus)) {{ $activesateus == 'products' ? 'active' : '' }} @endif">
                ...
                <ul class="nav-2-level collapse">
                    <li>
                        <a class="@if(isset($subactivesateus)) {{ $subactivesateus == 'products.add' ? 'active' : '' }} @endif" href="{{ route('album.create') }}">
                        <i class="sidebar-item-icon fa fa-headphones"></i>Add Album</a>
                    </li>
                    <li>
                        <a class="@if(isset($subactivesateus)) {{ $subactivesateus == 'products.manage' ? 'active' : '' }} @endif" href="{{ route('album.index') }}">
                        <i class="sidebar-item-icon fa fa-gear"></i>Manage Album</a>
                    </li>
                    <li>
                        <a class="@if(isset($subactivesateus)) {{ $subactivesateus == 'song.add' ? 'active' : '' }} @endif" href="{{ route('song.create') }}">
                        <i class="sidebar-item-icon fa fa-music"></i>Add Song</a>
                    </li>
                </ul>
            </li>
<!--==========================================---------------=====================-->
