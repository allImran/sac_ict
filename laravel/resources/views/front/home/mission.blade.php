        ...
        <div class="auto-container">
            ...
            <div class="feature-column col-lg-7 col-md-12 col-sm-12 col-xs-12">
                    <div class="inner-column">
                        <div class="sec-title">
                            <h2>Our Vision</h2>
                            <div class="text" style="font-size: 25px;line-height: 2;font-weight: bold;">“To preach out the Gospel among the nations without discrimination and elaborately through appropriate cultural method.”</div>
                        </div>
            ...
            <div class="feature-column col-lg-7 col-md-12 col-sm-12 col-xs-12">
                    <div class="inner-column">
                        <div class="sec-title">
                            ...
                            <div class="text">To fulfill the Great commission by <b>preaching the Gospel</b> among the nations through appropriate cultural method, <b>teaching & equipping </b> the generation to <b>grow with moral, spiritual and social value</b> and moreover to the <b>service of Christ</b> for establishing holistic model.</div>
                        </div>
                        <h2 style="padding:10px 10px;">Objectives :</h2>
