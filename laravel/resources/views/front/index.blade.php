...
@section('content')
                ...
                <ul>
                  @foreach($sliders as $slider)
                    ...
                    <li data-description="Slide Description" data-easein="default" data-easeout="default" data-fsmasterspeed="1500" data-fsslotamount="7" data-fstransition="fade" data-hideafterloop="0" data-hideslideonmobile="off" data-index="rs-{{ $loop->iteration }}" data-masterspeed="default" data-param1="" data-param10="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-rotate="0" data-saveperformance="off" data-slotamount="default" data-thumb="{{ asset('back/assets/img/slide/'.$slider->image) }}" data-title="Slide Title" data-transition="parallaxvertical">
                        ...
                        data-y="['middle','middle','middle','middle']"
                        data-frames='[{"from":"y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;s:inherit;e:inherit;","speed":1500,"to":"o:1;","delay":1000,"ease":"Power3.easeInOut"},{"delay":"wait","speed":1000,"to":"auto:auto;","mask":"x:0;y:0;s:inherit;e:inherit;","ease":"Power3.easeInOut"}]'>
                            {{-- <a href="{{ asset( 'assets/front') }}/about.html" class="theme-btn btn-style-one"><span>Read More</span></a> --}}
        ...
        <div class="inner-container">
            <div class="row clearfix">
                ...
                <div class="work-block col-md-4 col-sm-6 col-xs-12 wow fadeInUp">
                    <div class="inner-box" style="background-image: url({{ asset( 'assets/front') }}/images/home/product.jpg);">
                        <h3><a href="{{ asset( 'assets/front') }}/services.html">Be A Media Partner</a></h3>
                ...
                <div class="work-block col-md-4 col-sm-6 col-xs-12 wow fadeInUp" data-wow-delay="600ms">
                    <div class="inner-box" style="background-image: url({{ asset( 'assets/front') }}/images/home/rock.JPG);">
                        <h3><a href="{{ asset( 'assets/front') }}/services.html"> Scholarship For Music</a></h3>
                        <div class="text">Podcasting operational change management inside of workflows to establish a framework. Taking seamless key performance indicators offline to maximise the long tail.  management inside of workflows to establish a framework. Taking seamless key performance</div>
                        <div class="btn-box"><a href="{{ asset( 'assets/front') }}/services.html" class="theme-btn btn-style-three">Read More</a></div>
                    </div>
                </div>
                ...
                <div class="work-block col-md-4 col-sm-6 col-xs-12 wow fadeInUp" data-wow-delay="1200ms">
                    <div class="inner-box" style="background-image: url({{ asset( 'assets/front') }}/images/home/lfu.JPG);">
                        <h3><a href="{{ asset( 'assets/front') }}/services.html">Send Donation</a></h3>
                        <div class="text">Podcasting operational change management inside of workflows to establish a framework. Taking seamless key performance indicators offline to maximise the long tail.  management inside of workflows to establish a framework. Taking seamless key performance</div>
    ...
    <section class="event-section">
        <div class="title-box" style="background-image: url({{ asset( 'assets/front') }}/images/background/2.jpg);">
            ...
            <div class="auto-container">
                <div class="event-carousel owl-carousel owl-theme">
                    ...
                    <div class="event-block">
                        <div class="inner-box">
                            <div class="image-box">
                                <div class="image"><a href="{{ asset( 'assets/front') }}/event-single.html"><img src="{{ asset( 'assets/front') }}/images/resource/event-1.jpg" alt=""></a></div>
                            ...
                            <div class="lower-content">
                                ...
                                <h3><a href="{{ asset( 'assets/front') }}/event-single.html">Help volunteer to poor children Education</a></h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="event-block">
                        <div class="inner-box">
                            <div class="image-box">
                                <div class="image"><a href="{{ asset( 'assets/front') }}/event-single.html"><img src="{{ asset( 'assets/front') }}/images/resource/event-2.jpg" alt=""></a></div>
                                <span class="date"><strong>04</strong>May</span>
                            </div>
                            <div class="lower-content">
                                <ul class="info">
                                ...
                                <h3><a href="{{ asset( 'assets/front') }}/event-single.html">Food camp for childran in Africa</a></h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="event-block">
                        <div class="inner-box">
                            <div class="image-box">
                                <div class="image"><a href="{{ asset( 'assets/front') }}/event-single.html"><img src="{{ asset( 'assets/front') }}/images/resource/event-3.jpg" alt=""></a></div>
                                <span class="date"><strong>04</strong>May</span>
                            </div>
                            <div class="lower-content">
                                <ul class="info">
                                ...
                                <h3><a href="{{ asset( 'assets/front') }}/event-single.html">Green Organization to Founded</a></h3>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row clearfix">
                ...
                <div class="content-column pull-right col-md-6 col-sm-12 col-xs-12">
                    <div class="inner-column">
                        <div class="sec-title">
                            <h2>Welcome to Sacrifice Inter Church Ministry Since 2000</h2>
                            <div class="text">In 1999, a usual day like other days; a group of friends were sitting in a tea stall and were discussing about setting a day once a week for spending some time for God. So, we decided to sit in 29th August so that we can spend some time together in praying. At that time none of us could have thought that this sitting will eventually give birth to such a movement that will change the overall lookout of worship in Bangladesh. 
                            </div>
                        </div>
                        <div class="link-box"><a href="{{ route( 'history') }}" class="theme-btn btn-style-four">Read More</a></div>
                    </div>
                </div>
                ...
                <div class="video-column col-md-6 col-sm-12 col-xs-12">
                    <div class="inner-column wow fadeInLeft">
                        <figure class="image"><img src="{{ asset( 'assets/front') }}/images/home/intro.JPG" alt="">
                            <a href="{{ asset( 'assets/front') }}/https://www.youtube.com/watch?v=eAeDjyp7e2w" class="link" data-fancybox="gallery" data-caption=""><span class="icon fa fa-play"></span></a>
                        </figure>
                    </div>
                </div>
            </div>
        ...
        <div class="auto-container">
            ...
            <div class="causes-carousel owl-carousel owl-theme">
                ...
                <div class="cause-block">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure><img src="{{ asset( 'assets/front') }}/images/resource/cause-1.jpg" alt=""></figure>
                            <div class="overlay-box"><a href="{{ asset( 'assets/front') }}/causes-single.html" class="link">Donate Now</a></div>
                        </div>
                        <div class="lower-content">
                            <h3><a href="{{ asset( 'assets/front') }}/causes-single.html">Drought And Hunger</a></h3>
                            <div class="text">Integer et diam libero. Praesent  varius nisi. Nunc vCapitalize</div>
                        ...
                        <div class="info-box clearfix">
                            <a href="{{ asset( 'assets/front') }}/causes-single.html" class="raised">Raised: <span>$1000</span></a>
                            <a href="{{ asset( 'assets/front') }}/causes-single.html" class="goal">Goal: <span>$11000</span></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="cause-block">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure><img src="{{ asset( 'assets/front') }}/images/resource/cause-2.jpg" alt=""></figure>
                            <div class="overlay-box"><a href="{{ asset( 'assets/front') }}/causes-single.html" class="link">Donate Now</a></div>
                        </div>
                        <div class="lower-content">
                            <h3><a href="{{ asset( 'assets/front') }}/causes-single.html">Save Poor People</a></h3>
                            <div class="text">Integer et diam libero. Praesent  varius nisi. Nunc vCapitalize</div>
                            <div class="progress-bar">
                        ...
                        <div class="info-box clearfix">
                            <a href="{{ asset( 'assets/front') }}/causes-single.html" class="raised">Raised: <span>$1200</span></a>
                            <a href="{{ asset( 'assets/front') }}/causes-single.html" class="goal">Goal: <span>$31000</span></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="cause-block">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure><img src="{{ asset( 'assets/front') }}/images/resource/cause-3.jpg" alt=""></figure>
                            <div class="overlay-box"><a href="{{ asset( 'assets/front') }}/causes-single.html" class="link">Donate Now</a></div>
                        </div>
                        <div class="lower-content">
                            <h3><a href="{{ asset( 'assets/front') }}/causes-single.html">Send Food To Middle East</a></h3>
                            <div class="text">Integer et diam libero. Praesent  varius nisi. Nunc vCapitalize</div>
                            <div class="progress-bar">
                        ...
                        <div class="info-box clearfix">
                            <a href="{{ asset( 'assets/front') }}/causes-single.html" class="raised">Raised: <span>$5000</span></a>
                            <a href="{{ asset( 'assets/front') }}/causes-single.html" class="goal">Goal: <span>$31000</span></a>
                        </div>
                    </div>
                </div>
    ...
    <!-- Donation Section -->
    <section class="donation-section" style="background-image: url({{ asset( 'assets/front') }}/images/home/vision.jpg);">
        <div class="auto-container">
            <div class="row clearfix">
                <div class="title-column col-md-6 col-sm-12 col-xs-12">
                    <div class="inner-column">
                        <h2 style="text-align: left;">Our Vision is <br></h2>
                        <h2>To preach out the Gospel among the nations without discrimination and elaborately through appropriate cultural method.</h2>
                    </div>
                </div> 
                    ...
                    <div class="inner-column">
                        <div class="testimonial-carousel owl-carousel owl-theme">
                            ...
                            <div class="testimonial-block">
                                <div class="inner-box">
                                    <div class="text">“ It's my privillege to serve God's kingdom through Sacrifice Ministry. Since 2004, God has been called me to serve my nation for restoring His glory with appropriate cultural method. My heart's desire is to see a great transformation among the generation by fulfilling Great Commission.”</div>
                                    <div class="info">
                                        <span class="sign"><img src="{{ asset( 'assets/front') }}/images/home/sign.jpg" alt=""></span>
                                        <span class="name">Philip B Sarkar (Mridul)</span>
                            ...
                            <!-- <div class="testimonial-block">
                                <div class="inner-box">
                                    ...
                                    <div class="info">
                                        ...
                                        <span class="sign"><img src="{{ asset( 'assets/front') }}/images/resource/sign.png" alt=""></span>
                                    </div>
                                </div> 
                            </div> -->
